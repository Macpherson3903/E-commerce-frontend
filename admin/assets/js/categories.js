...
const categories = [
    { id: 1, name: "Power Tools", description: "Drills, saws, and grinders for heavy-duty tasks." },
    { id: 2, name: "Hand Tools", description: "Hammers, screwdrivers, and wrenches for precision work." },
    { id: 3, name: "Heavy Machinery", description: "Excavators, bulldozers, and cranes for construction." },
    { id: 4, name: "Safety Equipment", description: "Helmets, gloves, and protective gear." }
];
    ...
    try {
        ...
        data.forEach(category => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <a href="view_category.html?id=${category.id}" class="action-link"><i class="fas fa-eye"></i></a>
                    <a href="edit_category.html?id=${category.id}" class="action-link"><i class="fas fa-edit"></i></a>
                    <button class="action-btn delete-btn" data-id="${category.id}" data-name="${category.name}"><i class="fas fa-trash-alt"></i></button>
                </td>
            `;
